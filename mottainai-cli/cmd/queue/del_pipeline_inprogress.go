...
func newQueueDelPipelineInProgressCommand(config *setting.Config) *cobra.Command {
	var cmd = &cobra.Command{
		Use:   "del-pipeline-in-progress [OPTIONS]",
		Short: "Del pipeline in progress to a queue (dev only)",
