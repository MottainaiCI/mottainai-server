...
func newQueueDelTaskInProgressCommand(config *setting.Config) *cobra.Command {
	var cmd = &cobra.Command{
		Use:   "del-task-in-progress [OPTIONS]",
		Short: "Remove task in progress from a queue (dev only)",
