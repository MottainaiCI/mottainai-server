module github.com/MottainaiCI/mottainai-server
...
require (
	...
	github.com/docker/docker v17.12.0-ce-rc1.0.20190208221036-832ce62cb26d+incompatible // indirect
	...
	github.com/fsouza/go-dockerclient v1.3.6-0.20190203023949-f7ca8a3a751e
